                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('assets/images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg')}}" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg')}}" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="{{asset('assets/images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg')}}" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 ps-0">
                            <img src="{{asset('assets/images/gallery/medium-shot-man-getting-vaccine.jpg')}}" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-6 col-6 pe-0">
                            <img src="{{asset('assets/images/gallery/female-doctor-with-presenting-hand-gesture.jpg')}}" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="owl-carousel reviews-carousel">
                                ...
                                <div class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <h3 class=" text-primary primary d-block mt-2 mb-0 w-100"><strong>Dr. {{$fullName}}</strong></h3>
                                        <h5 class="text-primary w-100">Specialization: <span class="text-dark">{{ $doctor['specialization'] }} </span></h5> <br>
                                        <h5 class="text-primary w-100">Qualification: <span class="text-dark">{{ $doctor['qualification'] }} </span></h5> <br>
                                    
                                    <p class="text-dark w-100">Hi! I am Dr. {{$fullName}}. I am a Specialized {{ $doctor['specialization'] }}.Hope you'll have a great experience with me. </p>
                                     

                                    <img src="{{ asset('uploaded_images/' . $doctor->picture) }}" class="imgmama" alt="">
