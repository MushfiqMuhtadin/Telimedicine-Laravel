...
<body>
    <div class="container my-5">
        ...
        <form action="{{ route('appointment-created') }}" method="post">
            ...
            <input type="hidden" class="form-control" id="doctorid" name="doctorid" value="{{ $doctor->id }}"
                readonly>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="doctorname" name="doctorname"
                    value="{{ $doctor->firstname }}" readonly>
            </div>

            <div class="form-group">
                <label class="mt-3 fs-5 fw-semibold text-primary" for="specialization">SPECIALIZATION</label>
                <input type="text" class="form-control" id="specialization" name="specialization"
                    value="{{ $doctor->specialization }}"readonly>
            </div>


            <input type="hidden" class="form-control" id="patientid" name="patientid" value="{{ $patient->id }}"
                readonly>
