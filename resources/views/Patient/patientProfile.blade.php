                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="{{ asset('uploaded_images/' . $patient->picture) }}" alt="avatar"
                            ...
                            <p class="text-muted mb-2">{{ $patient->address }}</p>
                            <div class="d-flex justify-content-center mb-2">
                                <button type="button" class="btn btn-primary "><a
                                        href="{{ url('patient/dashboard/profile/' . $patientid) . '/edit' }}">Edit
                                        Profile</a></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body" style="height: 680px">
                            <div class="row  m-4">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0 ">{{ $patient->firstname }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row  m-4">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $patient->lastname }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row  m-4">
                            ...
                            <div class="row  m-4">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $patient->nid }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row  m-4">
