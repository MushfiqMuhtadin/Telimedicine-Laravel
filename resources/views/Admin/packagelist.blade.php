                ...
                <div class="col-12 col-lg-4  ">
                    <div class="card mb-5 mx-2 shadow-lg p-3 mb-5 bg-white rounded">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-text text-success ">Description: <span class="text-info" > {{ $package['description'] }}</span> </h6>
                            <h6 class="card-text  text-success fs-5">Price: <span class="fs-4" >{{ $package['price'] }}</span>$ </h6>
                            <br>
                            <div class="d-flex justify-content-start">
                                <button  class="btn btn-primary btn-sm mx-1"> <a class="text-white fs-5" href="{{ url('EditpackageGet/' . $package->id) }}">Edit</a></button>
